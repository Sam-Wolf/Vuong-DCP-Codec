...
// Added by Samuel Wolf - Begin
extern unsigned long compression_method1;
extern unsigned long compression_method2;
extern unsigned long compression_method3;

extern unsigned long decompression_method1;
...
extern unsigned int notification_level;

struct DLL_Info
{
	 char * variant_Names;
	 unsigned long  variant_IDs;
	 char *  variant_Paths;
};



extern DLL_Info dll_info[256];
